...
- **目标应用**: InvoicePlane (v1.5.9)
- **目标目录**: `applications/invoiceplane/1.5.9/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T19:31:54+08:00
...
| 静态检查 | `static.compose.specs` | docker/compose.yaml 规范性 | ✅ 通过 | 0.3ms | compose 规范合法，定义了标准服务 |
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 8.84s | 实机动态验证 PASS，端口 18541 正常工作 |
