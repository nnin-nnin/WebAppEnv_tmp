...
- **目标应用**: Carbon Forum (v5.9.0)
- **目标目录**: `applications/carbon-forum/5.9.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T21:07:18+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 15.74s | 实机动态验证 PASS，端口 18583 正常工作 |
