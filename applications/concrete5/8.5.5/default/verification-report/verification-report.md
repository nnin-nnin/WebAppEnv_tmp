...
- **目标应用**: Concrete5 (v8.5.5)
- **目标目录**: `applications/concrete5/8.5.5/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T01:05:58+08:00
...
| 静态检查 | `static.compose.specs` | docker/compose.yaml 规范性 | ✅ 通过 | 0.3ms | compose 规范合法，定义了 1 个符合 linux/amd64 标准的服务 (app) |
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 39.89s | 实机动态验证 PASS，端口 18618 正常工作，管理员登录成功 |
