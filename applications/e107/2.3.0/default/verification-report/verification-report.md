...
- **目标应用**: e107 (v2.3.0)
- **目标目录**: `applications/e107/2.3.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T00:41:04+08:00
...
| 静态检查 | `static.compose.specs` | docker/compose.yaml 规范性 | ✅ 通过 | 0.25ms | compose 规范合法，锁定 yorem/e107:2.3.0@sha256:6baef73c3a1157016cab45401bd036286f5ed40f4482dfedc33d1a4eaa926a86，符合 linux/amd64 标准且端口映射为 18604:80 |
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 71.18s | 实机动态验证 PASS，端口 18604 正常工作，全流程验证成功 |
