...
- **目标应用**: phpList (v3.7.0)
- **目标目录**: `applications/phplist/3.7.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T20:49:05+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 29.14s | 实机动态验证 PASS，端口 18568 正常工作 |
