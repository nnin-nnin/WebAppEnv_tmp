...
DOCKER_BUILDKIT=1 docker build --platform linux/amd64 \
    ...
    -f docker/Dockerfile -t yorem/glpi:10.0.15 .
docker save --output image/glpi-10.0.15-linux-amd64.tar yorem/glpi:10.0.15
docker image inspect yorem/glpi:10.0.15 > image/image.json
