...
- **目标应用**: SMF (v2.0.18)
- **目标目录**: `applications/smf/2.0.18/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T01:03:44+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 82.49s | 实机动态验证 PASS，端口 18622 正常工作 |
