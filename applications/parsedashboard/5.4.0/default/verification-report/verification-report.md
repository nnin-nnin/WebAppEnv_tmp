...
- **目标应用**: parsedashboard (v5.4.0)
- **目标目录**: `applications/parsedashboard/5.4.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T21:24:00+08:00
...
| 静态检查 | `static.ruby.validator` | 权威 Ruby 验证器 (validate_compose_delivery.rb) | ✅ 通过 | 58.5ms | 通过 Web应用环境仓库 官方权威验证器校验 (PASS) |
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 1.78s | 实机动态验证 PASS，端口 18592 正常工作 |
