...
- **目标应用**: CMS Made Simple (v2.2.23)
- **目标目录**: `applications/cmsmadesimple/2.2.23/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T20:07:20+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 16.51s | 实机动态验证 PASS，端口 18553 正常工作 |
