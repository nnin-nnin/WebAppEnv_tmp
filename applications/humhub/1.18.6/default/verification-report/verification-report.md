...
- **目标应用**: HumHub (v1.18.6)
- **目标目录**: `applications/humhub/1.18.6/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T20:35:15+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 32.57s | 实机动态验证 PASS，端口 18564 正常工作，管理员登录成功 |
