...
- **目标应用**: OrangeHRM (v5.7.0)
- **目标目录**: `applications/orangehrm/5.7.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T20:30:00+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 16.68s | 实机动态验证 PASS，端口 18566 正常工作 |
