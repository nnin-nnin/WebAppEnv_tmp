...
- **目标应用**: Bolt CMS (v3.7.1)
- **目标目录**: `applications/bolt/3.7.1/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T21:17:00+08:00
...
| 静态检查 | `static.compose.specs` | docker/compose.yaml 规范性 | ✅ 通过 | 0.3ms | compose 规范合法，定义了 1 个符合 linux/amd64 标准的服务 (bolt) |
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 8.64s | 实机动态验证 PASS，端口 18589 正常工作 |
