...
- **目标应用**: grafana (v11.0.0)
- **目标目录**: `applications/grafana/11.0.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T00:42:45+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 33.6s | 实机动态验证 PASS，端口 18606 正常工作 |
