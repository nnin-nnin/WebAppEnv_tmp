...
- **目标应用**: grafana (v11.2.0)
- **目标目录**: `applications/grafana/11.2.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T20:49:40+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 20.7s | 实机动态验证 PASS，端口 18573 正常工作 |
