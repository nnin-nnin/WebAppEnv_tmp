...
- **目标应用**: Pagekit (v0.10.8)
- **目标目录**: `applications/pagekit/0.10.8/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T21:22:25+08:00
...
| 静态检查 | `static.compose.specs` | docker/compose.yaml 规范性 | ✅ 通过 | 0.3ms | compose 规范合法，定义了标准服务 (web) |
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 14.55s | 实机动态验证 PASS，端口 18591 正常工作 |
