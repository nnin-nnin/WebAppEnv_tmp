# Dolibarr 23.0.3 应用环境

这是固定源码 commit `36001c855242d6d4f83d600c2e5a8586d73878d6` 构建的完整 Web 应用环境，目标平台为 `linux/amd64`。最终交付物是单镜像、单容器的 all-in-one 镜像 `yorem/dolibarr:23.0.3`，内部包含 Dolibarr、Apache、PHP 8.2 和 MariaDB 10.11。
