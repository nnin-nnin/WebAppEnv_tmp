...
ARCHIVE='image/dolibarr-23.0.3-linux-amd64.tar'
...
find source/dolibarr-23.0.3 -type f ! -path 'source/dolibarr-23.0.3/.git/*' -print0 | sort -z | xargs -0 sha256sum > source/SHA256SUMS
