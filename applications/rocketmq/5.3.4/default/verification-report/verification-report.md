...
- **目标应用**: rocketmq (v5.3.4)
- **目标目录**: `applications/rocketmq/5.3.4/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T21:23:09+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 21.62s | 实机动态验证 PASS，端口 18594 正常工作 |
