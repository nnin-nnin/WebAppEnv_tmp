...
- **目标应用**: mantisbt (v2.26.2)
- **目标目录**: `applications/mantisbt/2.26.2/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T20:30:03+08:00
...
| 静态检查 | `static.compose.specs` | docker/compose.yaml 规范性 | ✅ 通过 | 0.3ms | compose 规范合法，定义了 2 个符合 linux/amd64 标准的服务 (application, mariadb) |
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 15.10s | 实机动态验证 PASS，端口 18569 正常工作 |
