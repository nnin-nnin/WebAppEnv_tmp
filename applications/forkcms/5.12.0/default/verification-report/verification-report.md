...
- **目标应用**: ForkCMS (v5.12.0)
- **目标目录**: `applications/forkcms/5.12.0/default`
- **验证结论**: **`PASSED`**
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 16.34s | 实机动态验证 PASS，端口 18542 正常工作 |
