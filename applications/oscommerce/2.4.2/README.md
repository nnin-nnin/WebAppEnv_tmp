# osCommerce 2.4.2 all-in-one Application Environment ()

This is a reproducible environment built from pinned source commit `99fbb604bd1de8d1f13c792d378fd1952f64ca61` targeting platform `linux/amd64`。单个镜像内包含 osCommerce 前台、Administration Dashboard、PHP 8.3、Apache 和 MariaDB；没有独立数据库容器。
...
- Admin Dashboard: <http://127.0.0.1:18402/admin/>，登录后预期进入 Dashboard，可看到 Shop、Apps、Legacy 等后台导航。
