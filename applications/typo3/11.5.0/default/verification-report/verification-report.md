...
- **目标应用**: TYPO3 (v11.5.0)
- **目标目录**: `applications/typo3/11.5.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T01:07:20+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 14.6s | 实机动态验证 PASS，端口 18623 正常工作 |
