...
- **目标应用**: DreamFactory (v5.0.0)
- **目标目录**: `applications/dreamfactory/5.0.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T00:30:48+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 8.81s | 实机动态验证通过 (up -> healthcheck -> login -> reset)，耗时 8.81s，端口 18597 正常工作 |
