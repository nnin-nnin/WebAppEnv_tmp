# phpMyAdmin 4.7.9 all-in-one 应用环境

这是固定源码 commit `80914e327e4deafe78e0813ffdba7fce8acf10ac`（标签 `RELEASE_4_7_9`，附注标签对象 `98a32765caae870e0f9df3e3374ee5c8cff435e8`）的完整 Web 应用环境，目标平台为 `linux/amd64`。最终镜像为单镜像、单容器，内含 PHP 7.2、Apache、MariaDB 10.3、phpMyAdmin 浏览器前端、初始化数据库和管理员账号。
