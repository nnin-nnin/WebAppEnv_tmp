...
define('DB_COLLATE', '');
define('AUTH_KEY', 'wordpress-6.7.6-auth-key');
define('SECURE_AUTH_KEY', 'wordpress-6.7.6-secure-auth-key');
define('LOGGED_IN_KEY', 'wordpress-6.7.6-logged-in-key');
define('NONCE_KEY', 'wordpress-6.7.6-nonce-key');
define('AUTH_SALT', 'wordpress-6.7.6-auth-salt');
define('SECURE_AUTH_SALT', 'wordpress-6.7.6-secure-auth-salt');
define('LOGGED_IN_SALT', 'wordpress-6.7.6-logged-in-salt');
define('NONCE_SALT', 'wordpress-6.7.6-nonce-salt');
\$table_prefix = 'wp_';
