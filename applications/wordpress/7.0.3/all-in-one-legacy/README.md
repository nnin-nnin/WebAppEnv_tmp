# WordPress 7.0.3 Application Environment ()

This is a reproducible environment built from pinned source commit `9a094f4669547cea86ca354d1fb4d9fd9961028c` targeting platform `linux/amd64`. Delivered as an all-in-one container image `yorem/wordpress:7.0.3-aio`, encapsulating WordPress 7.0.3、PHP 8.2、Apache 和 MariaDB。
...
```bash
cd applications/wordpress/7.0.3/default
docker run -d -p 18513:80 yorem/wordpress:7.0.3-aio
```
