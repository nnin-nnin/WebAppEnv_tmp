# WordPress 7.0.3 应用环境

这是固定源码 commit `9a094f4669547cea86ca354d1fb4d9fd9961028c` 构建的完整 Web 应用环境，目标平台为 `linux/amd64`。最终交付是单镜像、单容器 all-in-one 镜像 `yorem/wordpress:7.0.3-aio`，内部包含 WordPress 7.0.3、PHP 8.2、Apache 和 MariaDB。
