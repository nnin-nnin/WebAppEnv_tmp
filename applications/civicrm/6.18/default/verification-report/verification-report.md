...
- **目标应用**: CiviCRM (v6.18)
- **目标目录**: `applications/civicrm/6.18/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T00:45:08+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 47.02s | 实机动态验证 PASS，端口 18599 正常工作，管理员登录成功 |
