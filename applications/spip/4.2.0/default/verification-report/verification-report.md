...
- **目标应用**: SPIP (v4.2.0)
- **目标目录**: `applications/spip/4.2.0/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T00:56:03+08:00
...
| 静态检查 | `static.compose.specs` | docker/compose.yaml 规范性 | ✅ 通过 | 0.3ms | compose 规范合法，定义了标准服务 (application, db) |
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 19.67s | 实机动态验证 PASS，端口 18611 正常工作 |
