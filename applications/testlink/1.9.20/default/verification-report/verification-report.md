...
- **目标应用**: testlink (v1.9.20)
- **目标目录**: `applications/testlink/1.9.20/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T00:41:00+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 19.86s | 实机动态验证 PASS，端口 18601 正常工作 |
