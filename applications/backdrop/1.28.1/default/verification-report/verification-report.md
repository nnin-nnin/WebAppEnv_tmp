...
- **目标应用**: Backdrop CMS (v1.28.1)
- **目标目录**: `applications/backdrop/1.28.1/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-23T20:56:30+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 12.15s | 实机动态验证 PASS，端口 18571 正常工作 |
