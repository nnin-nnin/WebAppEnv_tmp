 ...
 */
$database = array(
  'database' => getenv('BACKDROP_DB_NAME') ?: 'backdrop',
  'username' => getenv('BACKDROP_DB_USER') ?: 'backdrop',
  'password' => getenv('BACKDROP_DB_PASSWORD') ?: 'backdrop_pass',
  'host' => getenv('BACKDROP_DB_HOST') ?: 'db',
  'port' => getenv('BACKDROP_DB_PORT') ?: 3306,
  'driver' => 'mysql',
);
 ...
 */
$settings['backup_directory'] = 'files/backups_5d8aa3891553274f60be03b43ba7ed11';
 ...
 * @endcode
 */
$settings['hash_salt'] = 'nrEJmzqYcM2MSedTzK0TOfOhtnXKDSeHzP4u-5qVNYU';
