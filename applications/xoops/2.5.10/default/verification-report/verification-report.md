...
- **目标应用**: XOOPS (v2.5.10)
- **目标目录**: `applications/xoops/2.5.10/default`
- **验证结论**: **`PASSED`**
- **验证时间**: 2026-09-24T00:39:22+08:00
...
| 动态检查 | `dynamic.runtime_verify` | 动态实机全流程验证 (up -> healthcheck -> login -> reset) | ✅ 通过 | 14.0s | 实机动态验证 PASS，端口 18602 正常工作 |
